...
class FsmMediaAdapter:
    ...
    Mirrors certifications_api's own FsmMediaAdapter byte for byte (same
    protocol, different app registration): FSM owns the media key, this
    adapter persists that opaque key and never exposes the app credential to
    a frontend.
    """
